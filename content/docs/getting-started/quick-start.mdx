...
The local plugin provides autonomous self-learning with 22 MCP tools, 9 hook bindings, and a background daemon:
...
# Run setup (creates symlinks, injects hooks, adds permissions)
