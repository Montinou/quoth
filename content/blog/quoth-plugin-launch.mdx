...
The Quoth Plugin comes bundled with your Quoth MCP connection:

```bash
# If you haven't connected Quoth yet
claude mcp add --transport http quoth https://quoth.ai-innovation.site/api/mcp
```

The hooks activate automatically when Quoth detects a Claude Code session.
