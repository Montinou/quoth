...
describe('generateEmbeddingsBatch', () => {
  ...
  it('embeds valid texts and maps zero vectors for empty strings', async () => {
    const fakeEmbedding1 = new Array(1536).fill(0.5);
    const fakeEmbedding2 = new Array(1536).fill(0.7);
  ...
  it('maps results back to correct indices with mixed empty/valid', async () => {
    const e1 = new Array(1536).fill(1);
    const e2 = new Array(1536).fill(2);
